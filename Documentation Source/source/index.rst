...
- **Robust and manufacturable**
  ...
  - Designed to be machined out of hard plastic by a typical machine shop. A less durable version could be 3D printed
  - Zero exposed wires, all connections are integrated in the PCB or made with solder joints. 

    - Removes possiblity of connections coming loose or wires becoming damaged over time
